        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" :viewBox="'0 0 ' + (timeline.execucao.passou ? '900' : '800') + ' 300'">
          ...
          <g transform="translate(50, 0)">
            ...
            <g id="intimacao" transform="translate(162, 75)" :class="classes.intimacao">
              ...
              <rect transform="rotate(60)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.intimacao" />
              <a href="">
                <circle r="20" class="bola" @click.prevent="filtrarMovimentos('#intimacao')" />
              </a>
              <text class="textointerno" text-anchor="middle" alignment-baseline="central">
                {{ contador(timeline.intimacao.contador) }}
              </text>
              <text y="-40" class="texto" text-anchor="middle" alignment-baseline="middle">
                Intimação/Cit.
              </text>
            </g>

            <g id="juntada" transform="translate(262, 75)" :class="classes.juntada">
              <rect transform="rotate(60)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.juntada" />
              <a href="">
            ...
            <g id="audiencia" transform="translate(362, 75)" :class="classes.audiencia">
              <rect transform="rotate(60)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.audiencia" />
              <a href="">
            ...
            <g id="suspensao" transform="translate(495, 75)" :class="classes.suspensao">
              <rect transform="rotate(120)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.suspensao" />
              <a href="">
            ...
            <g id="apelacao" transform="translate(595, 75)" :class="classes.apelacao" v-show="timeline.apelacao.texto">
              <rect transform="rotate(120)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.apelacao" />
              <a href="">
            ...
            <g id="devolucao" transform="translate(312, 225)" :class="classes.devolucao">
              <rect x="-80" y="-5" width="60" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.devolucao" />
              <rect transform="rotate(-60)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.devolucao" />
              <a href="">
            ...
            <g id="remessa" transform="translate(212, 225)" :class="classes.remessa">
              ...
              <rect transform="rotate(-60)" x="20" y="-5" width="65" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.remessa" />
              <a href="">
            ...
            <g id="baixa" :transform="'translate(' + (timeline.execucao.passou ? '750' : '650') + ', 150)'" :class="classes.baixa">
              <rect x="-80" y="-5" width="60" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.baixa" />
              <a href="">
            ...
            <g id="execucao" transform="translate(650, 150)" v-if="timeline.execucao.passou" :class="classes.execucao">
              <rect x="-80" y="-5" width="60" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.execucao" />
              <a href="">
            ...
            <g id="sentenca" transform="translate(550, 150)" :class="classes.sentenca">
              <rect x="-80" y="-5" width="60" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.sentenca" />
              <a href="">
            ...
            <g id="conclusao" transform="translate(450, 150)" :class="classes.conclusao">
              <rect x="-280" y="-5" width="260" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.conclusao" />
              <a href="">
            ...
            <g id="distribuicao" transform="translate(150, 150)" :class="classes.distribuicao">
              <rect x="-80" y="-5" width="60" height="10" class="linha" v-b-tooltip data-html="true" :title="tooltips.distribuicao" />
              <a href="">
    ...
    <div class="row" v-if="!deviceDetector.raw.browser.chrome">
      <div class="col col-sm-12" v-show="!$parent.$parent.settings.timelineIncompatible">
        <p class="alert alert-danger alert-dismissible fade show" role="alert">
          ...
          {{ deviceDetector.raw.browser.chrome }} Seu navegador ({{ deviceDetector.browser }}) não é compatível com a <strong>Timeline Processual </strong>, por favor, utilize uma
