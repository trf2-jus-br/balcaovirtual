      ...
      <div class="col-md-12">
        ...
        <form class="css-form" role="form">
            ...
            <div class="col-lg-12">
              <div :class="{ 'form-group': true}">
                ...
                <validation-provider rules="required" :immediate="true" v-slot="{ errors }">
                  <textarea rows="4" :class="{'form-control': true, 'is-invalid': errors.length > 0 }" v-model="sugestao.mensagem" id="nome" name="mensagem" placeholder="">
                  </textarea>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-lg-12">
                <button class="btn btn-primary float-right" :disabled="invalid" @click.prevent="sugerir()">Enviar mensagem
                </button>
              </div>
            </div>
          </div>
