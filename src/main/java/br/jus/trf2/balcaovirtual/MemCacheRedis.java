...
public class MemCacheRedis implements IMemCache {
	...
	public static int getDatabase() {
		return Integer.parseInt(BalcaoVirtualServlet.INSTANCE.getProperty("redis.database"));
	}

	public static String getPassword() {
		return BalcaoVirtualServlet.INSTANCE.getProperty("redis.password");
	}

	public static int getSlavePort() {
		return Integer.parseInt(BalcaoVirtualServlet.INSTANCE.getProperty("redis.slave.port"));
	}

	public static String getSlaveHost() {
		return BalcaoVirtualServlet.INSTANCE.getProperty("redis.slave.host");
	}

	public static String getMasterHost() {
		return BalcaoVirtualServlet.INSTANCE.getProperty("redis.master.host");
	}

	public static int getMasterPort() {
		return Integer.parseInt(BalcaoVirtualServlet.INSTANCE.getProperty("redis.master.port"));
	}
