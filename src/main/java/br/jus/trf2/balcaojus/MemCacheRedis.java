...
public class MemCacheRedis implements IMemCache {
	...
	public static int getDatabase() {
		return Integer.parseInt(BalcaojusServlet.INSTANCE.getProperty("redis.database"));
	}

	public static String getPassword() {
		return BalcaojusServlet.INSTANCE.getProperty("redis.password");
	}

	public static int getSlavePort() {
		return Integer.parseInt(BalcaojusServlet.INSTANCE.getProperty("redis.slave.port"));
	}

	public static String getSlaveHost() {
		return BalcaojusServlet.INSTANCE.getProperty("redis.slave.host");
	}

	public static String getMasterHost() {
		return BalcaojusServlet.INSTANCE.getProperty("redis.master.host");
	}

	public static int getMasterPort() {
		return Integer.parseInt(BalcaojusServlet.INSTANCE.getProperty("redis.master.port"));
	}
