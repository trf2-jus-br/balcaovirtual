...
public class Correio {
	...
	public static void enviar(final String destinatario, final String assunto, final String conteudo,
		...
		Correio.enviar(BalcaojusServlet.INSTANCE.getProperty("smtp.remetente"), to, assunto, conteudo, null, nomeArquivo,
	...
	public static void enviar(final String remetente, final String[] destinatarios, final String assunto,
		...
		listaServidoresEmail.add(BalcaojusServlet.INSTANCE.getProperty("smtp.host"));
		String host2 = BalcaojusServlet.INSTANCE.getProperty("smtp.host.alt");
		if (host2 != null)
	...
	private static void enviarParaServidor(final String servidorEmail, String remetente, final String[] destinatarios,
		...
		if (Boolean.valueOf(BalcaojusServlet.INSTANCE.getProperty("smtp.auth"))) {
			props.put("mail.smtp.auth", "true");
			final String usuario = BalcaojusServlet.INSTANCE.getProperty("smtp.auth.usuario");
			final String senha = BalcaojusServlet.INSTANCE.getProperty("smtp.auth.senha");
		...
		tr.connect(servidorEmail, Integer.valueOf(BalcaojusServlet.INSTANCE.getProperty("smtp.porta")), null, null);
