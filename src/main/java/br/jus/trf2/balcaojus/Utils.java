...
public class Utils {
	...
	public static String getBaseUrl() {
		return BalcaojusServlet.INSTANCE.getProperty("base.url");
	}

	public static String[] getSystems() {
		String systems = BalcaojusServlet.INSTANCE.getProperty("systems");
		if (systems == null)
			return null;
	...
	public static String getName(String system) {
		try {
			return BalcaojusServlet.INSTANCE.getProperty(system.toLowerCase() + ".name");
		} catch (Exception e) {
			throw new RuntimeException("Erro de configuração", e);
		}
	}
	...
	public static String getSystemsNames() {
		...
		for (String system : systems) {
			String name = BalcaojusServlet.INSTANCE.getProperty(system.toLowerCase() + ".name");
			if (i == 0)
				s = "";
	...
	public static String getApiPassword(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".api.password");
	}

	public static String getApiUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".api.url");
	}

	public static String getApiEprocUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".api.eproc.url");
	}

	public static String getApiEprocVotosUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".api.eproc.votos.url");
	}

	public static String getApiEprocPassword(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".api.eproc.password");
	}

	public static String getCertApiUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".cert.api.url");
	}

	public static String getCertApiPassword(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".cert.api.password");
	}

	public static String getAssijusUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".assijus.url");
	}

	public static String getAssijusPassword(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".assijus.password");
	}

	public static String getMniWsdlUrl(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".mni.url");

	}

	public static String getMniWsdlEndpoint(String system) {
		return BalcaojusServlet.INSTANCE.getProperty(system + ".mni.endpoint");

	}

	public static String getWsDocumentalUrl() {
		return BalcaojusServlet.INSTANCE.getProperty("ws.documental.url");

	}

	public static String getDirTemp() {
		return BalcaojusServlet.INSTANCE.getProperty("upload.dir.temp");
	}

	public static String getDirFinal() {
		return BalcaojusServlet.INSTANCE.getProperty("upload.dir.final");
	}

	public static String getUsuariosRestritos() {
		return BalcaojusServlet.INSTANCE.getProperty("username.restriction");

	}

	public static String getJwtIssuer() {
		return BalcaojusServlet.INSTANCE.getProperty("jwt.issuer");
	}

	public static String getJwtPassword() {
		return BalcaojusServlet.INSTANCE.getProperty("jwt.secret");
	}

	public static String getApiPassword() {
		return BalcaojusServlet.INSTANCE.getProperty("api.secret");
	}

	public static String getAssijusEndpoint() {
		return BalcaojusServlet.INSTANCE.getProperty("assijus.endpoint");
	}

	public static String getAssijusSystemMovimentos() {
		return BalcaojusServlet.INSTANCE.getProperty("assijus.system.movimentos");
	}
	...
	public static ArrayList<IBalcaojus.ListStatus> getStatus(SwaggerMultipleCallResult mcr) {
		ArrayList<IBalcaojus.ListStatus> l = new ArrayList<IBalcaojus.ListStatus>();
		for (SwaggerCallStatus sts : mcr.status) {
			IBalcaojus.ListStatus lsts = new IBalcaojus.ListStatus();
	...
	public static boolean isConsultaPublica(String idConsultante) {
		return idConsultante.equalsIgnoreCase(BalcaojusServlet.INSTANCE.getProperty("public.username"));
	}
